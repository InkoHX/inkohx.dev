...
![変更前のDiscordのフォント表示](/img/articles/change-discord-font-to-sans-serif/before.png)
...
![変更後のDiscordのフォント表示](/img/articles/change-discord-font-to-sans-serif/after.png)
